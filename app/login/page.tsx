...
export default async function LoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* Glow blobs */}
      <div style={{ position: "absolute", top: "8%", left: "10%", width: 360, height: 360, borderRadius: "50%", background: "radial-gradient(circle, rgba(123,47,247,0.2) 0%, transparent 70%)", pointerEvents: "none" }} />
