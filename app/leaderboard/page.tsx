      ...
      <Box sx={{ maxWidth: 820, mx: "auto", position: "relative", zIndex: 1 }}>
        ...
        <Box sx={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 3, backdropFilter: "blur(12px)", boxShadow: "0 0 60px rgba(123,47,247,0.1), 0 8px 32px rgba(0,0,0,0.4)", overflow: "hidden" }}>
          ...
          {loading ? (
            ...
            return (
              <Box key={`${r.username}-${r.rank}`} sx={{ display: "grid", gridTemplateColumns: isMobile ? "44px 1fr 90px 70px" : "60px 1fr 120px 90px 90px 140px", px: isMobile ? 1.5 : 2.5, py: 1.6, borderBottom: "1px solid rgba(255,255,255,0.04)", background: isMe ? "rgba(123,47,247,0.12)" : r.rank <= 3 ? "rgba(255,255,255,0.015)" : "transparent", transition: "background 0.2s", alignItems: "center", "&:hover": { background: isMe ? "rgba(123,47,247,0.18)" : "rgba(255,255,255,0.03)" }, "&:last-child": { borderBottom: "none" } }}>
